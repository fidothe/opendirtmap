class RootController < ApplicationController
  ...
  def overlay
    @dirt_tagged_photos = flickr.photos.search :tags => "opendirtmaptagged", :extras => "geo,machine_tags,owner_name,path_alias", :per_page => 500, :auth => session[:flickr_auth_token]
  end
